...
| File | What it is |
|---|---|
| `prototype-status.md` | Where the prototype stands: what it does, every measured number, what's missing (round 12, the current one) |
...
| `adr-013-one-node-first-and-anything-in-a-column.md` | Current design: what made one node fast (strings as views, LZ4, four planning rules, the hot columns), files, bytes, `VARIANT`, vectors and models in SQL, functions of your own over Arrow Flight, and publishing that costs what changed |
