...
| File | What it is |
|---|---|
| `prototype-status.md` | Where the prototype stands: what it does, every measured number, what's missing (round 14, the current one) |
...
`../logs/round4/` to `../logs/round14/` hold the raw output of the test runs these reports quote.
